 ...
 * It requires a properties file with the necessary data to connect to your database in order work.
 */
public class ConnectionUtil {
    
    public static Connection createConnection(){
        try {
            // This create a Java object to represent our properties
            ...
            /*
             * we make use of the property values in the object created above the provide Java with the necessary
